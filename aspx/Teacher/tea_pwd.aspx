<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="tea_pwd.aspx.cs" Inherits="aspx_Teacher_tea_pwd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="/css/tea_pwd.css" rel="stylesheet" type="text/css" /> 
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
     <div class="center1_password_management">
        <div class="title_r">
            <a href="/aspx/Teacher/tea_main.aspx">个人中心</a>
            <em>></em>
            修改密码
        </div>
