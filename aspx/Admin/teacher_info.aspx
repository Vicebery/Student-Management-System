<%@ Page Title="" Language="C#" MasterPageFile="~/admin_content.master" AutoEventWireup="true" CodeFile="teacher_info.aspx.cs" Inherits="aspx_Admin_teacher_info" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head_chirld" Runat="Server">
    <link href="/css/teacher_info.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    <div class="ti_top">
         <asp:Label ID="lbl_back1" runat="server" Text=">>" CssClass="top_lbl" ></asp:Label>
         <asp:linkButton ID="btn_back1" runat="server" Text="教师信息列表" CssClass="top_btn" OnClick="btn_back1_Click"/>
